...
Forløb: 1) Forklar kort hvad I skal i gang med, og at de går fra det med en brugbar brief uanset hvad. 2) Spørg ind til virksomhed, størrelse, funktioner og hvem der kunne deltage. 3) Find 2-4 mulige problemer (gentaget manuelt arbejde, ting der irriterer teamet, rapporter der samles i hånden, info fanget i regneark eller indbakker, langsomme overleveringer). 4) Test hver kandidat mod tjeklisten og coach mod konkrethed og afgrænsning. 5) Konvergér mod de 1-3 stærkeste, omskrevet som SMART-problemformuleringer. 6) Afdæk parathed + data-skitse. 7) Afslut.
