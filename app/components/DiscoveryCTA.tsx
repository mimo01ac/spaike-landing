const steps = [
  ...
  },
  {
    num: "2",
    title: "Interviews",
    body: "5-10 medarbejdere har en kort AI-samtale om hverdagen (15-20 min hver).",
  },
  {
    num: "3",
    title: "Rapport",
    body: "I får en konkret handlings-rapport på 48 timer.",
  },
];

export default function DiscoveryCTA() {
  return (
    <section id="discovery" className="py-20 md:py-28">
      <div className="max-w-content mx-auto px-6 text-center">
        ...
        <p className="text-lg md:text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed mb-12 md:mb-16">
          SpAIke Discovery er vores gratis assessment-værktøj. Det interviewer 5-10
          medarbejdere via AI-samtaler, analyserer hvor tiden går, og leverer en
          prioriteret rapport med 3-5 konkrete forslag på 48 timer.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12 md:mb-16 text-left">
          {steps.map((step) => (
            <div
              key={step.num}
              className="bg-background-secondary border border-neutral-200 rounded-2xl p-6"
            >
        ...
        <p className="text-sm text-neutral-500 mt-6">
          Helt gratis under beta-fasen. Ingen forpligtelse. Ingen sælger på linjen.
        </p>
      </div>
    </section>
  );
